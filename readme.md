...
1. **Pure Vanilla JavaScript** - No dependencies means faster load times and easier maintenance. Although much of the JavaScript code was generated with AI assistance as I was learning the language, it helped me understand patterns and best practices.
2. **Responsive Grid Layouts** - Modern CSS Grid and Flexbox for flexible layouts
3. **One-File Simplicity** - All CSS in one file, all JS in one file—easy to navigate